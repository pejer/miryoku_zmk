...
&kp LBRC,          &kp CRRT,            &kp LS(BSLH),       &kp LS(NUM_8),          &kp LS(RA(NUM_8)),          U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
&kp COLON,         &kp RA(NUM_4),       &kp LS(NUM_5),      &kp LS(RBKT),           &kp MINUS,          U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
&kp TILDE,         &kp LS(NUM_1),       &kp RA(NUM_2),      &kp LS(NUM_3),          &kp PIPE,          U_NA,              &u_to_U_SYM,       &u_to_U_MOUSE,     &kp RALT,          U_NA,              \
